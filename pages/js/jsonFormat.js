...
function attachEvent(){
    var hideElems = document.getElementsByName('hide');
    for(var index=0; index<hideElems.length; index++){
        var hideElem = hideElems[index];
        hideElem.onclick = hide;
    }

    var showElems = document.getElementsByName('show');
    for(var index=0; index<showElems.length; index++){
        var hideElem = showElems[index];
        hideElem.onclick = show;
    }
}
